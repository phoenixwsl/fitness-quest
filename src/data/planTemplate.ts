...
const STRENGTH_A: TrainingTypePlan = {
  ...
  main: {
    ...
    bodyweight: [
      { name: '自重深蹲', prescription: '3 × 12', note: '椅子辅助→自由,躯干中立' },
      { name: '俯卧 YTW', prescription: '3 × 8', note: '替代「拉」:俯卧、拇指朝上,练上背后链' },
      { name: '上斜或跪姿到标准俯卧撑', prescription: '3 组', note: '力量不足先做上斜 / 跪姿版' },
      { name: '臀桥', prescription: '3 × 12', note: '顶峰收紧臀部,不靠腰发力' },
      { name: '死虫', prescription: '3 × 8 / 侧', note: '抗伸展核心,腰背贴地' },
    ],
  },
...
const STRENGTH_B: TrainingTypePlan = {
  ...
  main: {
    ...
    bodyweight: [
      { name: '分腿蹲(自重)', prescription: '3 × 8 / 侧', note: '两侧对等,膝不内扣' },
      { name: '上斜或跪姿到标准俯卧撑', prescription: '3 组', note: '替代地面卧推' },
      { name: '温和 superman', prescription: '3 × 8', note: '替代「拉」:后链,不过度后伸、不顶痛' },
      { name: '鸟狗', prescription: '3 × 8 / 侧', note: '抗旋转核心,缓慢可控' },
      { name: '侧桥', prescription: '3 × 20–30 秒 / 侧', note: '两侧对等,顾及侧弯对称' },
    ],
  },
